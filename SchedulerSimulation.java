...
public class SchedulerSimulation {
    private static int contextSwitches = 0; // Counter to track the number of context switches
    public static void main(String[] args) {
        // ⚠️ IMPORTANT: Put your student ID here to seed the random number generator
        // This makes your output unique to you - DO NOT forget to change this!
        int studentID = 445052835;  // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        while (!processQueue.isEmpty()) {
            ...
            contextSwitches++;  // Increment the context switch counter
      ...
      // display summary table
        ...
        new java.util.HashSet<>(processMap.values()).forEach(p -> {
            System.out.printf("%-13s | %-10d | %-12d%n", 
